...
parser = argparse.ArgumentParser(description="train-lenet-adder")
...
class LeNet(nn.Module):
    def __init__(self):
        ...
        self.conv1 = adder.adder2d(1, 60, kernel_size=5)

        self.relu = nn.ReLU()
        self.maxpool1 = nn.MaxPool2d(2, 2)
        self.conv2 = adder.adder2d(60, 16, kernel_size=5)
...
def train_and_test(epoch, start):
    ...
    test()
    if epoch % 10 == 0:
        torch.save(weights_best, args.output_dir + "lenet-adder_mono_best.pt")
    else:
        torch.save(net.state_dict(), args.output_dir + "lenet-adder_mono_temp.pt")
...
def main():
    ...
    torch.save(net.state_dict(), args.output_dir + "lenet-adder_mono_final.pt")
    torch.save(weights_best, args.output_dir + "lenet-adder_mono_best.pt")
